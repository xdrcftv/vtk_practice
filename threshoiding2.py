...
threshold.ThresholdBetween(-120, 400) # remove all soft tissue
threshold.ReplaceInOn() # Determines whether to replace the pixel in range with inValue
threshold.SetInValue(1) # Replace the in range pixels with this value
threshold.ReplaceOutOn() # Determines whether to replace the pixel out of range with OutValue
threshold.SetOutValue(0) # Replace the in range pixels with this value
threshold.Update()
